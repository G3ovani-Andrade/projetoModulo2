...
//        }
    ...
    public ResponseEntity<UsuarioResponseDto> atualizarSenhaUsuario(@PathVariable Long identificador, @RequestBody UsuarioAtualizacaoSenhaDto usuarioSenhaAtualizado) throws Exception {
       try {
